...
export declare const sendOtp: (name: string, email: string, next: NextFunction) => Promise<void>;
export declare const trackOtpRequest: (email: string, next: NextFunction) => Promise<void>;
export declare const verifyOtp: (req: Request, next: NextFunction) => Promise<void>;
